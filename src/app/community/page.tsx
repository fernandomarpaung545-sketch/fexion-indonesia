...
const MEMBERS = [
  { id: '1', name: 'Dr. Budi Santoso', title: 'Senior Petrophysicist', company: 'Pertamina EP', location: 'Jakarta', disciplines: ['Petrophysics', 'Formation Evaluation'], yearsExperience: 18, memberNumber: 'GEOFERA-00042', memberSince: '2022', isVerified: true },
  { id: '2', name: 'Ir. Dewi Rahayu', title: 'Wellsite Geologist', company: 'Medco E&P', location: 'Palembang', disciplines: ['Wellsite Geology', 'Mud Logging', 'Geosteering'], yearsExperience: 12, memberNumber: 'GEOFERA-00078', memberSince: '2022', isVerified: true },
  { id: '3', name: 'Ahmad Fauzi, M.T.', title: 'Formation Evaluation Engineer', company: 'Schlumberger', location: 'Balikpapan', disciplines: ['Formation Evaluation', 'Petrophysics'], yearsExperience: 9, memberNumber: 'GEOFERA-00115', memberSince: '2023' },
  { id: '4', name: 'Sari Wulandari', title: 'Reservoir Geologist', company: 'Chevron Pacific', location: 'Jakarta', disciplines: ['Reservoir Geology', 'Formation Evaluation'], yearsExperience: 14, memberNumber: 'GEOFERA-00163', memberSince: '2023', isVerified: true },
  { id: '5', name: 'Rizky Pratama', title: 'Mud Logging Engineer', company: 'Halliburton', location: 'Balikpapan', disciplines: ['Mud Logging', 'Wellsite Geology'], yearsExperience: 6, memberNumber: 'GEOFERA-00201', memberSince: '2023' },
  { id: '6', name: 'Dr. Hendra Kurniawan', title: 'Geosteering Specialist', company: 'Baker Hughes', location: 'Jakarta', disciplines: ['Geosteering', 'Drilling', 'Reservoir Geology'], yearsExperience: 20, memberNumber: 'GEOFERA-00034', memberSince: '2022', isVerified: true },
  { id: '7', name: 'Nurul Hidayah, S.T.', title: 'CCS Engineer', company: 'Shell Indonesia', location: 'Jakarta', disciplines: ['CCS', 'Reservoir Geology'], yearsExperience: 7, memberNumber: 'GEOFERA-00287', memberSince: '2024' },
  { id: '8', name: 'Andri Setiawan', title: 'Drilling Engineer', company: 'Pertamina Hulu Energi', location: 'Surabaya', disciplines: ['Drilling', 'Formation Evaluation'], yearsExperience: 11, memberNumber: 'GEOFERA-00199', memberSince: '2023' },
  { id: '9', name: 'Fitria Handayani', title: 'Petrophysicist', company: 'TotalEnergies EP', location: 'Bandung', disciplines: ['Petrophysics', 'Formation Evaluation', 'Reservoir Geology'], yearsExperience: 8, memberNumber: 'GEOFERA-00241', memberSince: '2023', isVerified: true },
  { id: '10', name: 'Dimas Ardiansyah', title: 'Wellsite Geologist', company: 'Vaalco Energy', location: 'Batam', disciplines: ['Wellsite Geology', 'Mud Logging'], yearsExperience: 5, memberNumber: 'GEOFERA-00334', memberSince: '2024' },
  { id: '11', name: 'Ratna Sari Dewi', title: 'Subsurface Integration Engineer', company: 'Eni Indonesia', location: 'Jakarta', disciplines: ['Drilling', 'Formation Evaluation', 'CCS'], yearsExperience: 13, memberNumber: 'GEOFERA-00089', memberSince: '2022', isVerified: true },
  { id: '12', name: 'Guntur Wibowo', title: 'Reservoir Geologist', company: 'Repsol Indonesia', location: 'Balikpapan', disciplines: ['Reservoir Geology', 'Geosteering'], yearsExperience: 10, memberNumber: 'GEOFERA-00156', memberSince: '2023' },
];
